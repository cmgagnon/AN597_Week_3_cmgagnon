...
```
*I didn't realize you could assign the variables like this- I used x = 2, l = 15*
...
y
```
*wondering if we should be using the set.seed = TRUE here so that they are the same set everytime??* 
...
<li>Couldn't figure out the right function to get the probilities for a poisson distribution.</li> *I also struggled figuring this out*
